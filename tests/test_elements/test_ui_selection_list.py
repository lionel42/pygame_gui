...
class TestUISelectionList:
    ...
    def test_process_event(
        ...
        unselect_event = pygame.event.Event(
            pygame_gui.UI_BUTTON_PRESSED, event_data
        )
    ...
    def test_set_relative_position(
        ...
        test_container = UIContainer(
            relative_rect=pygame.Rect(100, 100, 300, 300),
            manager=default_ui_manager,
        )
        selection_list = UISelectionList(
    ...
    def test_default_selection_changes(
        ...
        event_data = {
            "ui_element": single_list.item_list_container.elements[
                new_selection
            ]
        }
        select_event = pygame.event.Event(
        ...
        for selection in selections:
            event_data = {
                "ui_element": multi_list.item_list_container.elements[
                    selection
                ]
            }
            select_event = pygame.event.Event(
